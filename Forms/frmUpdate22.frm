...
Begin VB.Form frmUpdate22 
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Please wait while I connect to the internet to check for an update..."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
...
Dim bTest As Byte
      ...
      ' Call PutIni("AutoUpdate", "WebHost", "http://home.clara.net/mrenigma")
      ...
      If Left$(LatestVersion, 7) <> "VERSION" Then
         ' MsgBox "Invalid file.  No version was specified in this file.", vbCritical + vbOKOnly
         Exit Sub
      End If
      ...
      IRCIniFile.Default = "1.6.0"
      lCurVer = CLng(Replace(IRCIniFile.Value, ".", ""))
      ' Stop
      ...
      If CLng(LatestVersion) > lCurVer Then
         ...
         Connectionstatus.Caption = "Connected: Found New Version: Version " & sVersion
      Else
      ...
      ' Load frmCheckLatest
      ' frmCheckLatest.bHidePopup = True
