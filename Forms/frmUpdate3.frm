...
Begin VB.Form frmUpdate3 
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Please click the ""Update"" button to update."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
...
Dim sPath As String
      ...
      Label2.Caption = "Please wait... while the update is downloaded... "
      On Error Resume Next
      ...
      Open App.Path & "\IRCDominator.ex_" For Binary As #TFile
      bGettingFile = False
      sSize = Inet1.OpenURL(sPath & "/Update/size.txt", icString)
'      Stop
'      sSize = "389120"
      DoEvents
      ...
      bGettingFile = True
      Inet1.Execute sPath & "/IRCDominator.exe", "GET " & sPath & "/IRCDominator.exe " & App.Path & "\IRCDominator.ex_"
End Sub
